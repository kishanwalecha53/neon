    ...
    tasks.spawn({
        ...
        async move {
            ...
            loop {
                ...
                info!("[tomo-id-007] neon/pageserver/pagebench/src/cmd/ondemand_download_churn.rs: evictions={evictions_per_s:.2}/s downloads={downloads_per_s:.2}/s download_bytes={downloads_mibs_per_s:.2}MiB/s timeline_restarts={timeline_restarts}");
            }
        }
    });
