...
async fn main_impl(args: Args) -> anyhow::Result<()> {
    ...
    tracing::info!("[tomo-id-001] neon/pageserver/pagebench/src/cmd/aux_files.rs: operating on timeline {timeline}");
    ...
    for batch in 0..100 {
        ...
        mgmt_api_client
            ...
            .await?;
        tracing::info!("[tomo-id-002] neon/pageserver/pagebench/src/cmd/aux_files.rs: ingested {file_cnt} files");
    }
